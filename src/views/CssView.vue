<template>
    <div class="pagina">
        <h1>Estudo CSS</h1>
        <h3>A idéia é pensar no css como caixas</h3>
        <div class="exemplo1">
            <div class="quadrado quadrado1">
                <h4>Texto</h4>
            </div>
        </div>
        ...
        <div class="linha">
            ...
            <div class="quadrado quadrado6">
                <h4>Texto</h4>
            </div>
            <div class="quadrado quadrado7">
                <h4>Texto</h4>
            </div>
        </div>
        <div class="linha">
